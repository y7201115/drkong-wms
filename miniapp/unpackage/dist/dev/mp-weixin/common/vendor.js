...
/* 3 */
/*!******************************************************************!*\
  !*** C:/Users/Administrator/Desktop/deepseek/miniapp/pages.json ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
function flushCallbacks$1(vm) {
    if (vm.__next_tick_callbacks && vm.__next_tick_callbacks.length) {
        if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"江博士仓库管理","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 53 */
/*!**********************************************************************!*\
  !*** C:/Users/Administrator/Desktop/deepseek/miniapp/api/request.js ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function request() {
  ...
  var url = options.url,
    ...
    _options$needToken = options.needToken,
    needToken = _options$needToken === void 0 ? true : _options$needToken;
      ...
      success: function success(res) {
        ...
        if (statusCode >= 200 && statusCode < 300) {
          ...
          if (responseData.code === 0 || responseData.success) {
            ...
            // 业务错误
            var errorMsg = responseData.message || responseData.msg || '请求失败';
            uni.showToast({
              title: errorMsg,
              icon: 'none',
              duration: 2000
          ...
          reject(new Error("\u8BF7\u6C42\u5931\u8D25: ".concat(statusCode)));
        }
      },
...
var _default = {
  ...
  upload: function upload(url, filePath) {
...
/* 70 */
/*!************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/deepseek/miniapp/utils/barcode.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function parseBarcode(barcode) {
  ...
  var format2 = /^([A-Za-z0-9]+)--PIK(\d+(?:\.5)?)-$/.exec(trimmed);
  if (format2) {
    return {
      articleNo: format2[1],
      rawSize: format2[2],
  ...
  var format1 = /^([A-Za-z0-9]+?)(\d)(\d{2})(\d)$/.exec(trimmed);
  if (format1) {
    var halfIndicator = format1[2];
    var sizeNum = format1[3];
    var suffix = format1[4];

    // 判断半码: 如果倒数第二位前一位是5则为半码，如果是0则为正码
    var isHalf = halfIndicator === '5';
    var size = isHalf ? "".concat(sizeNum, ".5") : sizeNum;
    return {
      articleNo: format1[1],
      rawSize: isHalf ? "".concat(sizeNum, ".5") : sizeNum,
 ...
 * @returns {string}
 */
function generateBarcode(articleNo, size) {
  var format = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'S';
  if (!articleNo || !size) return '';
  var isHalf = String(size).includes('.5');
  var cleanSize = String(size).replace('.5', '');
  var paddedSize = cleanSize.padStart(2, '0');
  if (format === 'B') {
    var halfIndicator = isHalf ? '5' : '0';
    return "".concat(articleNo).concat(halfIndicator).concat(paddedSize, "0");
  } else {
    // 默认 S 格式暂不支持反向生成
    return "".concat(articleNo, "--PIK").concat(size, "-");
  }
}
...
function isValidBarcode(barcode) {
  ...
  var result = parseBarcode(barcode);
